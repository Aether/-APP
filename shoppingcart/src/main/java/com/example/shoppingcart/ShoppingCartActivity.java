...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ArrayList<Goods> dataList,typeList;
    public static SparseArray<Goods> selectedList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList = Goods.getGoodsList();
        typeList = Goods.getTypeList();
    ...
    private void query(){
        BmobQuery<GoodsItem> query = new BmobQuery<>();
...
//                        Goods.getGoodsList().add(new Goods(cnt++,item.getPrice(),item.getName(),1," "));
                        dataList.add(new Goods(cnt++,item.getPrice(), item.getName(),1," "));
                    }
                    initView();
                }
                else {
        ...
        Log.d("testt","list number is " + Goods.getGoodsList().size());
    }
    ...
    private void initView(){
        ...
        Log.d("testt","laaa"+(listView == null));
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                if (dataList.size() < firstVisibleItem){
                    Goods item = dataList.get(firstVisibleItem);
    ...
    public void add(Goods item, boolean refreshGoodList){
        ...
        Goods temp = selectedList.get(item.id);
        if (temp == null) {
            item.count = 1;
